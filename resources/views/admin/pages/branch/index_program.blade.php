            ...
            <div class="box box-danger">
                ...
                <div class="box-body">
                    ...
                    <div class="row" style="padding: 10px;">
                        <div class="col-md-12">
                        <a href="/admin/branch-courses/create" class="btn btn-md btn-danger"><i class="fa fa-plus"></i> Add Program</a><hr>
                        </div>
                    </div>
                    <table id="data-table" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ strtoupper($cat->branch->name) ?? '--' }}</td>
                                <td>
                                @if($cat->status == '1')
                                ...
                                <td>
                                    <div class="btn-group">
                                    <a class="btn btn-success" href="{{ route('branch-courses.show',['id' => $cat->id]) }}"><i class="fa fa-eye"></i></a>
                                    <a class="btn btn-warning" href="{{ route('branch-courses.edit',['id' => $cat->id ]) }}"><i class="fa fa-pencil"></i></a>
                                    </div>
