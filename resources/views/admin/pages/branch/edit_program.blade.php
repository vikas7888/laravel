        ...
        <div class="col-xs-12">
            <div class="box box-danger">
                ...
                <div class="box-body">
                    ...
                    <form method="POST" action="{{ route('branch-courses.update',$cat->id) }}"
                        ...
                        <fieldset>
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <select name="intern" class="form-control" required>
                                @foreach($interns as $intern)
                                    <option value="{{ $intern->id }}" @if($intern->id == $cat->intern_id) selected @endif>{{ $intern->name }}</option>
                                @endforeach
                                </select>
