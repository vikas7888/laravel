        ...
        <div class="col-xs-12">
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h2 class="box-title"><b>Edit Trainer</b></h2>
                ...
                <div class="row" style="padding: 10px;">
                    <div class="col-md-12">
                    <a href="/admin/trainer" class="btn btn-md btn-success"><i class="fa fa-arrow-left"></i> Back </a><hr>
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    ...
                    <form method="POST" action="{{ route('trainer.update',['id'=>$trnr->id]) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="text" class="form-control" name="name" value="{{ ucwords($trnr->name) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        ...
                                        <select class="form-control" name="status" required="required">
                                            <option value="1" @if($trnr->status == '1') selected @endif>Active</option>

                                            <option value="0" @if($trnr->status == '0') selected @endif>In Active</option>
                                        </select>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
